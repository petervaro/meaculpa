...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - */
#define MC__PANIC_INI_VA1(T, P) MC__PANIC_INI_##T(P, NULL, mc_Error_OKAY, NULL)
#define MC__PANIC_INI_VA2(T, P, O) MC__PANIC_INI_##T(P, NULL, mc_Error_OKAY, NULL)
#define MC__PANIC_INI_VA3(T, P, O, E) MC__PANIC_INI_##T(P, O, E, NULL)
#define MC__PANIC_INI_VA4(T, P, O, E, U) MC__PANIC_INI_##T(P, O, E, U)
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - */
